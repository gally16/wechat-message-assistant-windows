...
a = Analysis(
    ...
    hiddenimports=['PyQt5', 'PyQt5.QtCore', 'PyQt5.QtGui', 'PyQt5.QtWidgets', 'qfluentwidgets', 'Crypto.Cipher.AES', 'sqlite3', 'json', 'threading', 'datetime', 'collections', 'ctypes', 'struct', 'watchdog', 'winotify'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
